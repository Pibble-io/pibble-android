...
public abstract class AlertVerticalDialog extends Dialog implements View.OnClickListener {
    ...
    protected AlertVerticalDialog(@NonNull Context context, String title, String message, String btnTitle1, String btnTitle2, int buttonColor1, int buttonColor2) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.item_alertview_vertical_dialog);
        ...
        if (button1 == null) {
            ...
            txt_message.setTextColor(context.getResources().getColor(R.color.black));
        } else {
            txt_action.setText(button1);
            txt_action.setTextColor(context.getResources().getColor(button1Color));
        }

        txt_cancel.setText(button2);
        txt_cancel.setTextColor(context.getResources().getColor(button2Color));
    ...
    public void onClick(View v) {
        if (v == btn_action) onClickButton(0);
        else if (v == btn_cancel) onClickButton(1);
    }
