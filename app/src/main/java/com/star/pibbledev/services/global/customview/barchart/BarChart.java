...
public class BarChart extends FrameLayout {
    ...
    private ArrayList<BarChartModel> barChartModels = new ArrayList<>();
...
//                (int) BarChartUtils.convertDpToPixel(20, context));
    ...
    public ArrayList<BarChartModel> getBar() {
    ...
    //vertical chart
    public void setBarWidthValue(int barWidthValue) {
        this.barDimension = barWidthValue;
    }

    //horizontal chart
    public void setBarHeightValue(int barHeightValue) {
        this.barDimension = barHeightValue;
    }
    ...
    private void updateUi(int position, int dimension, BarChartModel barChartModelInit,
        ...
        if (barChartModel.getBarTitle() != null) {
            TextView txtTitle = view.findViewById(R.id.txt_bar_title);
            txtTitle.setText(barChartModel.getBarTitle());
        } else {
            view.findViewById(R.id.txt_bar_title).setVisibility(GONE);
        }
        ...
        view.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                if (isHeightRequested) {
                    listener.onDimensionReceived(view.getHeight() - (int) BarChartUtils.convertDpToPixel(34, context));
                } else {
     ...
     */
    public void addBar(ArrayList<BarChartModel> barChartModelList) {
        ...
        if (barChartModel != null) {
            if (barType == BarChartUtils.BAR_CHART_HORIZONTAL) {
                ...
                if (verticalLinearParent.getHeight() == 0) {
                    ...
                    createVerticalChart(position, verticalLinearParent.getHeight() - (int) BarChartUtils.convertDpToPixel(34, context), barChartModel);
                }
            }
