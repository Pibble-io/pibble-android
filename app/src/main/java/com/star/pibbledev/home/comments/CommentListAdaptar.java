...
public class CommentListAdaptar extends BaseAdapter implements View.OnClickListener{
    ...
    public CommentListAdaptar(Context context, ArrayList<CommentsModel> pData, ReplyListener listener, CommentListener commentListener, ImageLoader imageLoader) {
    ...
    public class ViewHolder {
        ImageView img_user;
        TextView txt_userEmo, txt_comment, txt_date, txt_upvoteamount;
        Button btn_reply;
        LinearLayout linear_replies, linear_adaptar, linear_action;
...
//        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_list_home_comment, null);
            ...
            viewHolder.edit_layout = convertView.findViewById(R.id.edit_layout);
...
//        }
        ...
        viewHolder.edit_layout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
