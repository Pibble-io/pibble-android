...
public class SettingMutedUserRecyclerAdaptar extends RecyclerView.Adapter<SettingMutedUserRecyclerAdaptar.ViewHolder> {
    ...
    public SettingMutedUserRecyclerAdaptar(Context context, ArrayList<FriendsModel> data) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder(View itemView) {
            ...
            txt_action.setText(R.string.unmute);
        ...
        public void onClick(View view) {
            ...
            if (mClickListener != null) {
                ...
                if (view == linear_action) {
                    ...
                    mClickListener.onUserUnmute(getAdapterPosition());
    ...
    public interface listListener {
        ...
        void onUserUnmute(int position);
    }
}
